	    ...
	    .then(function(results){
		    ...
		    var handlerFactory = function(type) {
		      return function(x) {
		        $scope[type] = x;
		        ceacData = x.results
		        console.log("ceacData: ", ceacData)
		        
		        // Nu na het retourneren van de data de grafiek pas maken, moet anders want we willen alles laden bij het laden van de pagina
